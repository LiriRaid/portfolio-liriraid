...
export const createPortfolioAuraPreset = (
  primaryPalette: Record<string, string> = DEFAULT_PRIMARY_PALETTE,
  surfacePalette: Record<string, string> = DEFAULT_SURFACE_PALETTE
